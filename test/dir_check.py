...
for kaisai in kaisai_list:
    ...
    for kaisai_place in kaisai_place_list:
        ...
        for race in race_list:
            ...
            if 'win' in race and  pu.func_parser.does_final_odds_exist('tmp', date, kaisai_place['kaisai'], race_no, 'win') == False:
                #print('  -- {}/{}/{}/{}'.format(date, kaisai_place['kaisai'], race['no'],'win'))

                pu.func_parser.local_folder_check('tmp', date, kaisai_place['kaisai'], race_no, 'win')
