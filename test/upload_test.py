...
for kaisai in kaisai_list:
    ...
    for kaisai_place in kaisai_place_list:
        ...
        for race in race_list:
            ...
            if 'win' in race and pu.func_parser.final_odds_exist('tmp', date, kaisai_place['kaisai'], race_no, 'win') == False:
                pu.func_parser.folder_check('tmp', date, kaisai_place['kaisai'], race_no, 'win')
